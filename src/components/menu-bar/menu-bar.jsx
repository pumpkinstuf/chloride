                    ...
                    <div className={styles.fileGroup}>
                        {this.props.errors.length > 0 && <div>
                            ...
                            >
                                ...
                                >
                                    <MenuSection>
                                        <MenuItemLink href="https://scratch.mit.edu/users/Pumpkinbunny/#comments">
                                            <FormattedMessage
                            ...
                            >
                                ...
                                <MenuSection>
                                    ...
                                    <Eruda>{(erudaToggle) => (
                                        ...
                                        >
                                            <FormattedMessage
                                                defaultMessage="Toggle DevTools"
                                                description="Menu bar item for toggling Eruda"
                                                id="tw.menuBar.erudaToggle"
                                            />
                                        </MenuItem>
                                    )}</Eruda>
